...
def getJSONSandcheck():
  ...
  if(os.path.isfile('calendar1_data.json')):
        with open('calendar1_data.json') as data_file:
            calendar1_data = json.load(data_file)
  calendar1 = calendar()
  calendar1.add_events(calendar1_data)

  if(os.path.isfile('calendar2_data.json')):
        with open('calendar2_data.json') as data_file:
